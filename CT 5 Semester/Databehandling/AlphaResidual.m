...
ylabel('y [m]')
set(gca,'fontsize',15)
plot(x1Fit(t1),y1,'linewidth',1)
plot(x2Fit(t2),y2,'linewidth',1)
plot(x1,y1,'.')
plot(x2,y2,'.')
...
ylabel('\Deltax [m]')
set(gca,'fontsize',15)
plot(ts1,Rfun(betaX1,ts1),'linewidth',1.5)
plot(ts2,Rfun(betaX2,ts2),'linewidth',1.5)
...
ylabel('x [m]')
set(gca,'fontsize',15)
plot(ts1,x1Fit(ts1),'linewidth',2)
plot(ts2,x2Fit(ts2),'linewidth',2)
plot(t1,x1,'.')
plot(t2,x2,'.')
...
ylabel('v [m/s]')
set(gca,'fontsize',15)
plot(x1Fit(ts1),v1Fit(ts1),'linewidth',2)
plot(x2Fit(ts2),v2Fit(ts2),'linewidth',2)
legend('Fit 1','Fit 2')
...
ylabel('a [m/s^2]')
set(gca,'fontsize',15)
plot(x1Fit(ts1),ddRfun(betaX1,ts1),'linewidth',2)
plot(x2Fit(ts2),ddRfun(betaX2,ts2),'linewidth',2)
legend('Fit 1','Fit 2')
...
xs= Rfun(betaX1,ts1);
plot(x1Fit(ts1),Alpha,'linewidth',2)
...
plot(edges,gauss(beta,edges),'linewidth',1)
