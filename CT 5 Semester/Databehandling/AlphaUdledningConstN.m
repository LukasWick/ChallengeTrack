...
betaX1=nlinfit(t1,x1,@(a,t)Rfun(a,t),ones(1,n_poly+1));
betaY1=nlinfit(t1,y1,@(a,t)Rfun(a,t),ones(1,n_poly+1));

betaX2=nlinfit(t2,x2,@(a,t)Rfun(a,t),ones(1,n_poly+1));
betaY2=nlinfit(t2,y2,@(a,t)Rfun(a,t),ones(1,n_poly+1));
...
ylabel('\Deltax [m]')
set(gca,'fontsize',15)
plot(t1,x1-betaX1(1)-betaX1(2).*t1,'.')
plot(t2,x2-betaX2(1)-betaX2(2).*t2,'.')
plot(ts1,Rfun(betaX1,ts1)-betaX1(1)-betaX1(2).*ts1-betaX1(3).*ts1.^2)
plot(t2Adapted,Rfun(betaX2,t2Adapted)-betaX2(1)-betaX2(2).*t2Adapted)
legend('Path 1','Path 2','Fit 1','Fit 2')
...
plot(ts1,betaX1(1)+betaX1(2).*ts1)
