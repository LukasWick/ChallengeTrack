...
XSS1(end+1,:) = x1Fit(ts1)
XSS2(end+1,:) = x2Fit(ts2)
...
plot(flip(as(1:59)))
%%
mean_speed1 = mean(SPEEDS1)
mean_speed2 = mean(SPEEDS2)
mean_acc1 = mean(ACC1)
mean_acc2 = mean(ACC2)
mean_x1 = mean(XSS1)
mean_x2 = mean(XSS2)
figure
plot(mean_x1,mean_speed1)
hold on
plot(mean_x2,mean_speed2)

plot(Xs(62:end),vs(62:end),'-.')
plot(flip(Xs(1:59)),flip(vs(1:59)),'-.')

figure
plot(mean_x1,mean_acc1)
hold on
plot(mean_x2,mean_acc2)
plot(Xs(62:end),as(62:end),'-.')
plot(flip(Xs(1:59)),flip(as(1:59)),'-.')

%%
figure
Alpha = -(mean_acc2-mean_acc1)./(mean_speed1-mean_speed2);
plot(Alpha)
histogram(Alpha,100)
%%
